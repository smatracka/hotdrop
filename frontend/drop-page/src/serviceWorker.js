...
function showUpdateNotification() {
  ...
  notificationElement.className = 'app-update-notification';
  notificationElement.innerHTML = `
    <div class="update-content">
      <p>Nowa wersja aplikacji jest dostępna</p>
      <button id="update-app-btn">Odśwież aby zaktualizować</button>
      <button id="dismiss-update-btn">Później</button>
    </div>
  `;
